...
3. If signal matches known_issue → **continue**
4. circuit_breaker_active → only **suggest**, never stop
5. warning_escalation → escalate to **suggest** with stop recommendation
6. Include reasoning_trace explaining your decision

## Output Format
{ "decision": "continue|stop|collect_more|extend_wait|pause|suggest", "reason": "...", "confidence": 0.0-1.0, "reasoning_trace": "..." }
